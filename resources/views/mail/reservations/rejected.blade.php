<x-layouts.email>
    ...
    <p>Rest assured, your payment has been cancelled. Your funds will be returned to you by {{ Carbon\Carbon::today()->addDays(10)->format('F jS') }}. If you have any questions, please feel free to reply to this email.</p>
