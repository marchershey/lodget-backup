<div class="minimal-section-spacing" wire:init="load">
    @if ($property)
        ...
        <div class="minimal-section">
            ...
            <div class="flex justify-between">
                <div class="flex flex-col">
                    ...
                    <span class="font-semibold">4 guests</span>
                </div>
                <div class="flex flex-col text-center">
                    <span class="text-muted">Check-in</span>
                    <span class="font-semibold">Aug 17th</span>
                </div>
                <div class="flex flex-col text-right">
                    <span class="text-muted">Check-out</span>
                    <span class="font-semibold">Aug 20th</span>
        ...
        <form wire:submit.prevent="submit" class="minimal-section">
...
{{-- <div class="section-spacing space-y-5 sm:mt-5" wire:init="load">
    @if ($property)
        <div class="reserve-section">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium">Payment method</h1>
                <div>
        ...
        <div class="reserve-section">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-medium">BLANK</h1>
            </div>
            <div></div>
        </div>
    @else
